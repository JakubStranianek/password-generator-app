  ...
  return (
    <div>
        <div className='relative w-11/12 mr-auto ml-auto flex justify-center md:w-[540px]'>
            <input type={'text'} placeholder="P4$5W0rD!" value={props.pass} readOnly className='bg-myGrey w-full text-myWhite h-16 pl-8 text-headingM  focus:outline-none'></input>
